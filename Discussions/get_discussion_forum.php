        ...
        while ($query_row = mysqli_fetch_assoc($query_for_all_queries)) {
            ...
            if ($query_row['parent_query_id'] == 0) {
                $output = $output.'<div class="d-flex ml-5 mt-3">
                                        ...
                                        <div class="card ml-3 p-3" style="border-left: 5px solid #4285f4;">
                                            ...
                                            <div class="reply_to_'.$query_row['query_id'].'" style="display: none;">
                                                <textarea class="form-control" id="Reply_'.$query_row['query_id'].'" placeholder="Type Reply..."></textarea>
                                                <button class="btn btn-primary btn-sm waves-effect px-3" id="sendReply" data-parentid='.$query_row['query_id'].'>Submit</button>
                                            </div>
                                        </div>
                                    </div>';
            }
                ...
                $output = $output.'<div class="ml-5 mt-3 d-flex">
                                        ...
                                        <div class="card ml-3 p-3" style="border-left: 5px solid #dc3545;">
