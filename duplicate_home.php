...
?>
    ...
    <body class="skin-light bg-dark">
        ...
        <nav class="navbar navbar-expand-sm navbar-dark bg-dark sticky-top scrolling-navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarMenu">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect text-white" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
            ...
            <div class="container">
                ...
                <section class="mt-2 mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <!-- Card -->
                            <div class="card profile-card sticky-top bg-dark text-white" style="top: 65px;">
                                ...
                                <div class="card-body card-body-cascade text-center text-white">
                                    ...
                                    <!-- Text -->
                                    <p class="card-text text-white"><?php echo $skill; ?></p>

                                    <p class="card-text text-white">“<?php echo $user_row['quote']; ?>”</p>

                                    <p class="card-text text-white"><?php echo $about; ?></p>
                        ...
                        <div class="col-lg-6">
                            ...
                            <?php while ($row = mysqli_fetch_assoc($res)) { ?>
                                ...
                                <!-- Card -->
                                <div class="card media-card mt-2 bg-dark text-white">
                                ...
                                ?>'>
                                    ...
                                    <div class="input-group px-3">
                                        <input id="comment<?php echo $row['post_id']; ?>" type="text" class="form-control bg-dark" placeholder="Comment here..." aria-label="Comment here..." aria-describedby="MaterialButton-addon2">
                        ...
                        <div class="col-lg-3">
                            <!-- Card -->
                            <div class="card friends-card sticky-top bg-dark text-white" style="top: 65px;">
                                <!-- Card content -->
                                <div class="card-body">
                                    ...
                                    <div id="friends" class="frndContainer bg-dark" style="height: 400px;overflow-y: auto;"></div>
